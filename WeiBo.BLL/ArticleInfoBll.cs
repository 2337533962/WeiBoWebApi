...
namespace WeiBoWebApi.BLL
{
    ...
    public partial class ArticleInfoBll
    {
        ...
        {
            //调用数据访问层查询方法并将查询结果返回
            return this._articleInfoDal.GetModel(articleId);
        }
        /// <summary>
        /// 根据主键删除一条记录
        /// </summary>
        ...
        public bool Delete(int articleId)
        {
            ...
            return this._articleInfoDal.Delete(articleId);
        }
        /// <summary>
        /// 判断是否有此主键对应的记录
        /// </summary>
        ...
        public bool Exists(int articleId)
        {
            ...
            return this._articleInfoDal.Exists(articleId);
        }
        /// <summary>
        /// 更新数据
        /// </summary>
        ...
        public bool Update(ArticleInfo articleInfo)
        {
            ...
            return this._articleInfoDal.Update(articleInfo);
        }
        /// <summary>
        /// 判断是否有此记录
        /// </summary>
        ...
        public bool Exists(ArticleInfo articleInfo)
        {
            ...
            return this._articleInfoDal.Exists(articleInfo);
        }
        /// <summary>
        ...
        {
            //调用数据访问层方法
            return this._articleInfoDal.Exists(where, sqlParameters);
        }
        /// <summary>
        /// 自定义删除
        /// </summary>
        ...
        public bool Delete(string where, params SqlParameter[] sqlParameters)
        {
            ...
            return this._articleInfoDal.Delete(where, sqlParameters);
        }
        /// <summary>
        /// 自定义查找
        /// </summary>
        ...
        public List<ArticleInfo> GetModelList(string where, params SqlParameter[] sqlParameters)
        {
            ...
            return this._articleInfoDal.GetModelList(where,sqlParameters);
        }
        /// <summary>
        /// 自定义查询出匹配记录有多少条
        /// </summary>
        ...
        public int GetCount(string where, params SqlParameter[] sqlParameters)
        {
            ...
            return this._articleInfoDal.GetCount(where,sqlParameters);
        }
        /// <summary>
        /// 分页获取数据
        /// </summary>
        ...
        public List<ArticleInfo> GetListByPage(string where, string orderby, bool isDesc, int startIndex, int endIndex, params SqlParameter[] sqlParameters)
        {
            ...
            return this._articleInfoDal.GetListByPage(where,orderby,isDesc,startIndex,endIndex,sqlParameters);
        }
        /// <summary>
        /// 分页获取数据并返回总记录条数
        /// </summary>
        ...
        {
            //调用数据访问层分页获取数据方法
            return this._articleInfoDal.GetMinutePage(where, orderby, isDesc, pageIndex, pageItemCount, sqlParameters);
        }
        /// <summary>
        /// 分页获取数据并返回总记录条数
        /// </summary>
        ...
        {
            //调用数据访问层分页获取数据方法
            return this._articleInfoDal.GetMinutePage(where, orderby, isDesc, pageIndex, pageItemCount, out allItmeCount, sqlParameters);
        }
    }
}
