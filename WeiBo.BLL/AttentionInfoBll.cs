...
namespace WeiBoWebApi.BLL
{
    ...
    public partial class AttentionInfoBll
    {
        ...
        public bool Add(AttentionInfo attentionInfo)
        {
            ...
            return this._attentionInfoDal.Add(attentionInfo);
        }
        /// <summary>
        /// 更新数据
        /// </summary>
        ...
        public bool Update(AttentionInfo attentionInfo)
        {
            ...
            return this._attentionInfoDal.Update(attentionInfo);
        }
        /// <summary>
        /// 判断是否有此记录
        /// </summary>
        ...
        public bool Exists(AttentionInfo attentionInfo)
        {
            ...
            return this._attentionInfoDal.Exists(attentionInfo);
        }
        /// <summary>
        ...
        {
            //调用数据访问层方法
            return this._attentionInfoDal.Exists(where, sqlParameters);
        }
        /// <summary>
        /// 自定义删除
        /// </summary>
        ...
        public bool Delete(string where, params SqlParameter[] sqlParameters)
        {
            ...
            return this._attentionInfoDal.Delete(where, sqlParameters);
        }
        /// <summary>
        /// 自定义查找
        /// </summary>
        ...
        public List<AttentionInfo> GetModelList(string where, params SqlParameter[] sqlParameters)
        {
            ...
            return this._attentionInfoDal.GetModelList(where,sqlParameters);
        }
        /// <summary>
        /// 自定义查询出匹配记录有多少条
        /// </summary>
        ...
        public int GetCount(string where, params SqlParameter[] sqlParameters)
        {
            ...
            return this._attentionInfoDal.GetCount(where,sqlParameters);
        }
        /// <summary>
        /// 分页获取数据
        /// </summary>
        ...
        public List<AttentionInfo> GetListByPage(string where, string orderby, bool isDesc, int startIndex, int endIndex, params SqlParameter[] sqlParameters)
        {
            ...
            return this._attentionInfoDal.GetListByPage(where,orderby,isDesc,startIndex,endIndex,sqlParameters);
        }
        /// <summary>
        /// 分页获取数据并返回总记录条数
        /// </summary>
        ...
        {
            //调用数据访问层分页获取数据方法
            return this._attentionInfoDal.GetMinutePage(where, orderby, isDesc, pageIndex, pageItemCount, sqlParameters);
        }
        /// <summary>
        /// 分页获取数据并返回总记录条数
        /// </summary>
        ...
        {
            //调用数据访问层分页获取数据方法
            return this._attentionInfoDal.GetMinutePage(where, orderby, isDesc, pageIndex, pageItemCount, out allItmeCount, sqlParameters);
        }
    }
}
