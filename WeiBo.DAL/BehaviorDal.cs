...
namespace WeiBoWebApi.DAL
{
    ...
    /// Behavior数据访问对象
    /// </summary>
    public partial class BehaviorDal
    {
        /// <summary>
        /// 实例化Behavior数据访问对象
        /// </summary>
        ...
        public List<BehaviorInfo> GetAllModel()
        {
            //创建存储查找到的Behavior表中信息集合
            List<BehaviorInfo> list = new List<BehaviorInfo>();
            //使用查询语句查询出所有信息
            using (SqlDataReader sqlReader = SqlDataBase.ExecuteReader("Select uid,behavior From Behavior;"))
            {
                ...
                if (sqlReader.HasRows)
                {
                    ...
                    {
                        //创建一个Behavior数据模型对象
                        BehaviorInfo behavior = new BehaviorInfo();
                        //存储查询到的uid数据
        ...
        public bool Add(BehaviorInfo behavior)
        {
            //创建存储参数的数组
        ...
        public bool Update(BehaviorInfo behavior)
        {
            //创建存储参数的数组
            SqlParameter[] sqlParameters = new[]
            {
        ...
        public bool Exists(BehaviorInfo behavior)
        {
            //创建存储参数的数组
            SqlParameter[] sqlParameters = new[]
            {
        ...
        public List<BehaviorInfo> GetModelList(string where, params SqlParameter[] sqlParameters)
        {
            //创建存储[会员名称]数据模型对象的集合
            List<BehaviorInfo> list = new List<BehaviorInfo>();
            //创建存储执行语句的字符串
        ...
        public List<BehaviorInfo> GetListByPage(string where, string orderby, bool isDesc, int startIndex, int endIndex, params SqlParameter[] sqlParameters)
        {
            //判断传入的条件是否为“;”如果是就移除
        ...
        /// <param name="sqlParameters">所需SQL参数对象数组</param>
        /// <returns>查询到的Behavior数据模型对象集合</returns>
        public List<BehaviorInfo> GetMinutePage(string where, string orderby, bool isDesc, int pageIndex, int pageItemCount, params SqlParameter[] sqlParameters)
        {
            //得到开始索引
        ...
        /// <param name="sqlParameters">所需SQL参数对象数组</param>
        /// <returns>查询到的Behavior数据模型对象集合</returns>
        public List<BehaviorInfo> GetMinutePage(string where, string orderby, bool isDesc, int pageIndex, int pageItemCount, out int allItmeCount, params SqlParameter[] sqlParameters)
        {
            //得到总记录条数
